<div x-data="{
...
}" @profile-updated.window="showToaster('Profile updated successfully!', 'success')"
    ...
    <div x-show="showToast" x-transition:enter="transition ease-out duration-300"
        ...
        <div :class="{
            ...
            <!-- Success Icon -->
            <svg x-show="toastType === 'success'" class="w-6 h-6 flex-shrink-0 text-white" fill="none"
                stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>

            <!-- Error Icon -->
            <svg x-show="toastType === 'error'" class="w-6 h-6 flex-shrink-0 text-white" fill="none"
                stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
            </svg>

            <span x-text="toastMessage" class="flex-1 text-white"></span>
    ...
    <form wire:submit.prevent="updateProfile">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div class="mb-6">
                ...
                <select id="address_type" wire:model="address_type"
        ...
        <div class="flex justify-end">
            <button type="submit" wire:loading.attr="disabled"
                ...
                <!-- Loading Spinner -->
                <svg wire:loading wire:target="updateProfile" class="animate-spin h-5 w-5 text-white"
