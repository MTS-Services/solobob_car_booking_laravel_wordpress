    ...
    @if ($deposits)
        <div>
            <x-backend.table :columns="$columns" :data="$deposits" :actions="$actions" search-property="search"
                per-page-property="perPage" empty-message="No Deposit Fund" />
        </div>
    @else
        <div class="text-center bg-gray-50 h-[50vh]">
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mb-2">No deposit Yet</h2>
            <p class="text-gray-500">Your Deposit history will appear here</p>
