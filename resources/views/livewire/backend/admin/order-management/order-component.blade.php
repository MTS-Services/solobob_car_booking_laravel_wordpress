    ...
    <section>
        ...
        <div class="flex items-center justify-between glass-card rounded-2xl p-6 mb-6">
            ...
            <div class="flex items-center gap-2">
                {{-- <x-button href="#" icon="trash-2" type='secondary' permission="order-trash">
                    {{ __('Trash') }}
                </x-button>
                            ...
                            <tr class="bg-zinc-50 transition-colors duration-150 ">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        <span class="text-accent text-sm">{{ $order->created_at_formatted }}</span>
                                        <span class="text-zinc-500 text-xs">{{ $order->created_at_human }}</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p class="text-zinc-500 text-lg">No orders found</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
