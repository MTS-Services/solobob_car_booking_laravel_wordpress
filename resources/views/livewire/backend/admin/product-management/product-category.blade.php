                        ...
                        <thead class="bg-zinc-600/50 border-b border-zinc-700">
                            <tr>
                                ...
                                <th
                                    ...
                                    Created By</th>
                                <th
                                    class="px-6 text-white py-4 text-right text-xs font-semibold uppercase tracking-wider">
                                    Actions</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="bg-zinc-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span
                                                class="text-accent text-sm">{{ $category->created_at_formatted }}</span>
                                            <span
                                                class="text-zinc-500 text-xs">{{ $category->created_at_human }}</span>
                                        </div>
                                    </td>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                    ...
                                    @if ($detailsAdmin->createdBy)
                                        <p class="text-xs text-zinc-400 mt-1">{{ $detailsAdmin->createdBy->email }}
                                        </p>
                                    @endif
                                </div>
                                ...
                                @if ($detailsAdmin->updated_at && $detailsAdmin->updated_at != $detailsAdmin->created_at)
                                    <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                        ...
                                        <p class="text-xs text-zinc-400 mt-1">{{ $detailsAdmin->updated_at_human }}
                                        </p>
                                    </div>
                                    ...
                                    @if ($detailsAdmin->updatedBy)
                                        <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                            ...
                                            <p class="text-zinc-200 font-medium">{{ $detailsAdmin->updatedBy->name }}
                                            </p>
                                            <p class="text-xs text-zinc-400 mt-1">
                                                {{ $detailsAdmin->updatedBy->email }}
                                            </p>
                                        </div>
                                    @endif
                                @endif
                                ...
                                @if ($detailsAdmin->deleted_at)
                                    <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                        ...
                                        <p class="text-xs text-zinc-400 mt-1">{{ $detailsAdmin->deleted_at_human }}
                                        </p>
                                    </div>
                                    ...
                                    @if ($detailsAdmin->deletedBy)
                                        <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                            ...
                                            <p class="text-zinc-200 font-medium">{{ $detailsAdmin->deletedBy->name }}
                                            </p>
                                            <p class="text-xs text-zinc-400 mt-1">
                                                {{ $detailsAdmin->deletedBy->email }}
                                            </p>
                                        </div>
                                    @endif
                                @endif
