<div>
    <div>
        ...
        <section>
            ...
            <x-backend.table :columns="$columns" :data="$vehiclefules" :actions="$actions" search-property="search"
                ...
                <div class="flex items-center justify-center min-h-screen px-4 py-6">
                    ...
                    <div
                        ...
                        <div class="px-6 py-4 border-b border-zinc-800 flex items-center justify-between">
                            <h3 class="text-lg font-semibold text-zinc-100">{{ __('Vehicle Fuel Details') }}</h3>
                        ...
                        <div class="px-6 py-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                    ...
                                    <p class="text-xs text-zinc-400 mt-1">{{ $detailsVehicleFuel->created_at_human }}
                                    </p>
                                </div>
                                ...
                                <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                    ...
                                    <p class="text-zinc-200 font-medium">
                                        {{ $detailsVehicleFuel->createdBy?->name ?? 'System' }}
                                    </p>
                                    @if ($detailsVehicleFuel->createdBy)
                                        <p class="text-xs text-zinc-400 mt-1">
                                            {{ $detailsVehicleFuel->createdBy->slug }}</p>
                                    @endif
                                </div>
                                ...
                                @if ($detailsVehicleFuel->updated_at && $detailsVehicleFuel->updated_at != $detailsVehicleFuel->created_at)
                                    <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                        ...
                                        <p class="text-zinc-200 font-medium">
                                            {{ $detailsVehicleFuel->updated_at_formatted }}</p>
                                        <p class="text-xs text-zinc-400 mt-1">
                                            {{ $detailsVehicleFuel->updated_at_human }}</p>
                                    </div>
                                    ...
                                    @if ($detailsVehicleFuel->updatedBy)
                                        <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                            ...
                                            <p class="text-zinc-200 font-medium">
                                                {{ $detailsVehicleFuel->updatedBy->name }}</p>
                                            <p class="text-xs text-zinc-400 mt-1">
                                                {{ $detailsVehicleFuel->updatedBy->email }}
                                            </p>
                                        </div>
                                    @endif
                                @endif
                                ...
                                @if ($detailsVehicleFuel->deleted_at)
                                    <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                        ...
                                        <p class="text-zinc-200 font-medium">
                                            {{ $detailsVehicleFuel->deleted_at_formatted }}</p>
                                        <p class="text-xs text-zinc-400 mt-1">
                                            {{ $detailsVehicleFuel->deleted_at_human }}</p>
                                    </div>
                                    ...
                                    @if ($detailsVehicleFuel->deletedBy)
                                        <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                                            ...
                                            <p class="text-zinc-200 font-medium">
                                                {{ $detailsVehicleFuel->deletedBy->name }}</p>
                                            <p class="text-xs text-zinc-400 mt-1">
                                                {{ $detailsVehicleFuel->deletedBy->email }}
                                            </p>
                                        </div>
                                    @endif
                                @endif
                        ...
                        <form wire:submit="save">
                            ...
                            <div class="px-6 py-4 border-b border-zinc-800">
                                <h3 class="text-lg font-semibold text-zinc-100">
                                    {{ $editMode ? __('Edit vehicle Fuel') : __('Create New Vehicle Fuel') }}
                                </h3>
                            </div>
                            ...
                            <div class="px-6 py-4 space-y-4">
                                ...
                                < </div>
                                    ...
                                    {{-- Footer --}}
                                    <div
                                        class="px-6 py-4 bg-zinc-800/30 border-t border-zinc-800 flex justify-end gap-3">
