        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li>
                        <a href="/apply" class="hover:text-zinc-500 transition-colors flex items-center">
                            <span class="mr-2 text-zinc-500">
                                <flux:icon name="chevrons-right" class="w-4" />
                            </span> Apply
                        </a>
                    </li>
                    <li>
                        <a href="/contact" class="hover:text-zinc-500 transition-colors flex items-center">
                            <span class="mr-2 text-zinc-500">
                                <flux:icon name="chevrons-right" class="w-4" />
                            </span> Contact
                        </a>
                    ...
                    <li>
                        <a href="/sign-agreement" class="hover:text-zinc-500 transition-colors flex items-center">
                            <span class="mr-2 text-zinc-500">
                                <flux:icon name="chevrons-right" class="w-4" />
                            </span> Sign Agreement
                        </a>
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    <li class="flex items-center">
                        <span class="mr-2 text-zinc-500">
                            <flux:icon name="phone" class="w-4" />
                        </span> 0123456789
                    </li>
                    <li class="flex items-center">
                        <span class="mr-2 text-zinc-500">
                            <flux:icon name="mail" class="w-4" />
                        </span> moneylord513@gmail.com
                    </li>
                    <li class="flex items-center">
                        <span class="mr-2 text-zinc-500">
                            <flux:icon name="map-pin" class="w-4" />
            ...
            <div>
                ...
                <p class="text-gray-400 flex items-center">
                    <span class="mr-2 text-zinc-500">
                        <flux:icon name="clock-3" class="w-4" />
                    </span> Monday - Friday
                </p>
            </div>
        </div>
