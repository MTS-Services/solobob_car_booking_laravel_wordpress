            ...
            <div class="w-full md:w-1/2 bg-white p-8 md:p-10">
                <div class="max-w-md mx-auto">
                    ...
                    <x-auth-session-status class="text-center" :status="session('status')" />
                        ...
                        <form method="POST" wire:submit="register" class="flex flex-col gap-6 text-gray-600">
                            <flux:input wire:model="name" :label="__('Name')" class="!text-gray-600" type="text" required autofocus autocomplete="name"
