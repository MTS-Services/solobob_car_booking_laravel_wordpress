    <section class="relative w-full bg-gray-50 overflow-hidden h-[65vh]">
            ...
            <div class="flex items-center justify-between h-full">
                ...
                <div class="flex-1 flex justify-start items-center z-50!">
                    <div class="max-w-[600px] -translate-x-8">
                        <img src="{{ asset('assets/images/banner_car.png') }}" alt="Gray SUV Car" class="w-full h-auto drop-shadow-2xl" />
                    </div>
                </div>
